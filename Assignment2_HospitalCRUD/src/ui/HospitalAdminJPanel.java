...
public class HospitalAdminJPanel extends javax.swing.JPanel {
    ...
    Date enDate;
    String enInfo;
    public HospitalAdminJPanel(PatientDirectory pd, DoctorDirectory dd, EncounterHistory eh, VitalSignsHistory vsh, JSplitPane sp, HospitalDirectory hd) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(btnViewUpdatePatient, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 165, -1, -1));
        ...
        add(btnUpdatePatient, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 700, -1, -1));
        ...
        add(btnViewDoctors, new org.netbeans.lib.awtextra.AbsoluteConstraints(262, 6, -1, -1));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(262, 47, 250, 100));
        ...
        add(btnViewUpdateDoctors, new org.netbeans.lib.awtextra.AbsoluteConstraints(274, 165, -1, -1));
        add(txtEmailId1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 250, 150, -1));

        boxGender1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Please Select a Gender", "Male", "Female", "Other" }));
        add(boxGender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 370, 150, -1));

        lblName1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblName1.setText("Name:");
        add(lblName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, -1, -1));

        lblDob1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblDob1.setText("Date of Birth:");
        add(lblDob1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, -1, -1));

        lblAge1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblAge1.setText("Age:");
        add(lblAge1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 330, -1, -1));
        ...
        add(txtName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 210, 150, -1));
        add(boxDob1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 290, 150, -1));

        lblGender1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblGender1.setText("Gender:");
        add(lblGender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 370, -1, -1));

        lblPhoneNo1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblPhoneNo1.setText("Cell Phone No:");
        add(lblPhoneNo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 440, -1, -1));
        ...
        add(txtAge1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 330, 150, -1));
        add(txtPhoneNo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 440, 150, -1));

        lblPassword1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblPassword1.setText("Password:");
        add(lblPassword1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 480, -1, -1));

        lblEmailId1.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblEmailId1.setText("Email ID:");
        add(lblEmailId1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 250, -1, -1));
        add(txtPassword1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 480, 150, -1));

        lblHospital.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblHospital.setText("Hospital:");
        add(lblHospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 610, -1, -1));
        add(txtSpeciality, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 520, 150, -1));
        add(txtYearsOfExp, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 560, 150, -1));
        add(txtHospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 610, 150, -1));

        lblSpeciality.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblSpeciality.setText("Speciality:");
        add(lblSpeciality, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 530, -1, -1));

        lblYearsOfExp.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblYearsOfExp.setText("Years of Experience:");
        add(lblYearsOfExp, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 560, -1, -1));

        lblArea.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblArea.setText("Area:");
        add(lblArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 650, -1, -1));
        add(txtArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 650, 150, -1));
        ...
        add(btnUpdateDoctor, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 700, -1, -1));
        ...
        add(lblHosCommunity, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, -1, -1));
        add(txtHosCommunity, new org.netbeans.lib.awtextra.AbsoluteConstraints(702, 247, 152, -1));

        lblHosCity.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblHosCity.setText("City:");
        add(lblHosCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(657, 294, -1, -1));
        ...
        add(btnAddHospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 340, -1, -1));
        ...
        add(btnUpdateHospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 340, -1, -1));

        lblHosName.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblHosName.setText("Name:");
        add(lblHosName, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 212, -1, -1));
        add(txtHosName, new org.netbeans.lib.awtextra.AbsoluteConstraints(702, 206, 152, -1));
        add(txtHosCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(702, 291, 152, -1));
        ...
        add(btnViewEncounters, new org.netbeans.lib.awtextra.AbsoluteConstraints(614, 418, -1, -1));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(614, 459, 250, 100));
        ...
        add(btnViewUpdateEncounter, new org.netbeans.lib.awtextra.AbsoluteConstraints(614, 577, -1, -1));

        lblDoctorName.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblDoctorName.setText("Doctor Name:");
        add(lblDoctorName, new org.netbeans.lib.awtextra.AbsoluteConstraints(627, 662, -1, -1));
        add(txtDoctorName, new org.netbeans.lib.awtextra.AbsoluteConstraints(733, 659, 150, -1));

        lblEnDate.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblEnDate.setText("Encounter Date:");
        add(lblEnDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(614, 700, -1, -1));

        lblPatientName.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblPatientName.setText("Patient Name:");
        add(lblPatientName, new org.netbeans.lib.awtextra.AbsoluteConstraints(625, 621, -1, -1));
        add(txtPatientName, new org.netbeans.lib.awtextra.AbsoluteConstraints(733, 618, 150, -1));

        lblEnInfo.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        lblEnInfo.setText("Info:");
        add(lblEnInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(682, 743, -1, -1));
        add(txtEnInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(733, 740, 150, -1));
        add(boxEnDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(733, 700, 150, -1));
        ...
        add(btnAddEncounter, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 790, -1, -1));
        ...
        add(btnUpdateEncounter, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 790, -1, -1));
    ...
    public Boolean doctorUpdateValidation(){
            ...
            if(updatedHospital.isBlank() || !(updatedHospital.matches("^[ a-zA-Z]*$"))){
            ...
            if(updatedArea.isBlank() || !(updatedArea.matches("^[ a-zA-Z]*$"))){
    ...
    public Boolean hospitalValidation(){
            ArrayList message = null;
            message = new ArrayList(0);
            if (hosName.isBlank() || !(hosName.matches("^[ a-zA-Z]*$"))){
                message.add("Name cannot be blank, contain digits or special characters. Please enter a valid name and try again");
            }
            if (hosCommunity.isBlank() || !(hosCommunity.matches("^[ a-zA-Z]*$"))){
                message.add("Community cannot be blank, contain digits or special characters. Please enter a valid community and try again");
            }
            if (hosCity.isBlank() || !(hosCity.matches("^[ a-zA-Z]*$"))){
                message.add("City cannot be blank, contain digits or special characters. Please enter a valid city and try again");
            }
            if(!(message.isEmpty())){
            JOptionPane.showMessageDialog(this, message.toArray());
